                ...
                <form id="myForm" action="{{ route('update.course') }}" method="post" class="row g-3"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="selling_price" class="form-control" id="input1"
                            placeholder="First Name" value="{{ $course->selling_price }}">
                    </div>

                    <div class="form-group col-md-3">
                        <label for="input1" class="form-label">Discount Price</label>
                        <input type="text" name="discount_price" class="form-control" id="input1"
                            placeholder="First Name" value="{{ $course->discount_price }}">
                    </div>

                    <div class="form-group col-md-3">
                        <label for="input1" class="form-label">Duration</label>
                        <input type="text" name="duration" class="form-control" id="input1" placeholder="First Name"
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" name="resources" class="form-control" id="input1"
                            placeholder="First Name" value="{{ $course->resources }}">
                    </div>

                    <div class="form-group col-md-12">
                        <label for="input1" class="form-label">Course Prerequisites</label>
                        <textarea name="prerequisites" class="form-control" id="input11" placeholder="prerequisites..." rows="3">{{ $course->prerequisites }}
                        </textarea>
                    </div>
