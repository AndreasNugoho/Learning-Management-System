                ...
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset($course->course_image) }}" class="p-1 border rounded-circle" width="90"
                                height="90" alt="...">
                                        ...
                                        <div class="p-4 card-body d-flex justify-content-between">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <form action="{{ route('delete.section', ['id' => $item->id]) }}"
                                                    ...
                                                    <button type="submit" class="px-2 btn btn-danger ms-auto"> Delete
                                                        Section</button> &nbsp;
                                        ...
                                        <div class="courseHide" id="lectureContainer{{ $key }}">
                                            <div class="container">
                                                @foreach ($item->lectures as $lecture)
                                                    <div
                                                        class="mb-3 lectureDiv d-flex align-items-center justify-content-between">
                                                        <div>
